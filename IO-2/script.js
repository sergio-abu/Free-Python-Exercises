const quizData = [
    {
        question: `Which of the following commands is used 
to open a file in binary format for writing only?`,
    ...
    {
        question: `Which of the following open modes allow you 
...
regarding the opening modes of a file?`,
    ...
    {
        question: `Which method will you use to read one line 
from a text file?`,
        a: `readlines()`,
        b: `readline()`,
        c: `readln()`,
    ...
    {
        question: `You want to write a new player to a file 
...
What snippet would you insert in the line indicated below:
    ...
    {
        question: `Which of the following commands can be used to 
read the next line from a file?`,
    ...
    {
        question: `What is the content of the file xyz.txt after 
...
you want to override the existing content.
Which of the following commands do you have to choose?`,
    ...
    {
        question: `If x is a file opened in read mode, 
...
can be used to read n characters from a file?`,
    ...
    {
        question: `What does the readline() method return, 
...
Which of the modes below do you have to use 
to only open the file for writing?`,
        a: `at`,
        b: `at+`,
        c: `ab`,
        d: `at+`,
